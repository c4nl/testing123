...
echo '<link rel="icon" href="assets/img/logo.png" type="image/png">';
echo '<link rel="apple-touch-icon" href="http">';
echo '<meta name="description" content="cancel">';
echo '<link rel=“canonical” href="https://cancel.lol/404">';
echo '<meta name="theme-color" content="#00000">';
echo '<meta property="og:type" content="website">';
echo '<meta property="og:url" content="cancel.lol">';
echo '<meta property="og:title" content="cancel.lol" />';
echo '<meta property="og:description" content="cancel.lol runs cord" />';
echo '<meta property="og:image" content="https://cancel.lol/assets/logo.png">';
echo '<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">';
echo '<meta charset="utf-8">';
echo '<meta http-equiv="X-UA-Compatible" content="IE=edge">';
echo '<meta name="viewport" content="width=device-width, initial-scale=1">';
echo '<link rel="stylesheet" href="assets/css/landing.css">';
echo '<title>Cancel - 404</title>';
echo '</head>';
echo '<body>';
echo '<style>';
echo '@import url(https://fonts.googleapis.com/css?family=Gilda+Display);';
echo '';
echo 'html {';
...
echo 'font-family: 'Gilda Display', serif;';
echo '';
echo 'text-align: center;';
echo 'width: 100%;';
echo 'height: 120px;';
...
echo 'left: -60px;';
echo 'right: 0;';
echo '-webkit-animation: noise-3 1s linear infinite;';
echo 'animation: noise-3 1s linear infinite;';
echo 'overflow: default;';
echo '}';
echo '';
echo 'body:after {';
echo 'content: 'error 404';';
echo 'font-family: OCR-A;';
...
echo 'opacity: 0;';
echo 'color: white;';
echo '-webkit-animation: noise-1 .2s linear infinite;';
echo 'animation: noise-1 .2s linear infinite;';
echo '}';
echo 'body:before {';
echo 'content: 'error 404';';
echo 'font-family: OCR-A;';
...
echo 'opacity: 0;';
echo 'color: white;';
echo '-webkit-animation: noise-2 .2s linear infinite;';
echo 'animation: noise-2 .2s linear infinite;';
echo '}';
echo '';
echo '.info {';
echo 'text-align: center;';
...
echo '}';
echo '';
echo '@-webkit-keyframes noise-1 {';
echo '0%, 20%, 40%, 60%, 70%, 90% {opacity: 0;}';
echo '10% {opacity: .1;}';
echo '50% {opacity: .5; left: -6px;}';
echo '80% {opacity: .3;}';
echo '100% {opacity: .6; left: 2px;}';
echo '}';
echo '';
echo '@keyframes noise-1 {';
echo '0%, 20%, 40%, 60%, 70%, 90% {opacity: 0;}';
echo '10% {opacity: .1;}';
echo '50% {opacity: .5; left: -6px;}';
echo '80% {opacity: .3;}';
...
echo '}';
echo '';
echo '@-webkit-keyframes noise {';
echo '0%, 3%, 5%, 42%, 44%, 100% {opacity: 1; -webkit-transform: scaleY(1); transform: scaleY(1);}';
echo '4.3% {opacity: 1; -webkit-transform: scaleY(1.7); transform: scaleY(1.7);}';
echo '43% {opacity: 1; -webkit-transform: scaleX(1.5); transform: scaleX(1.5);}';
echo '}';
echo '';
echo '@keyframes noise {';
echo '0%, 3%, 5%, 42%, 44%, 100% {opacity: 1; -webkit-transform: scaleY(1); transform: scaleY(1);}';
echo '4.3% {opacity: 1; -webkit-transform: scaleY(1.7); transform: scaleY(1.7);}';
echo '43% {opacity: 1; -webkit-transform: scaleX(1.5); transform: scaleX(1.5);}';
echo '}';
echo '';
echo '@-webkit-keyframes noise-3 {';
echo '0%,3%,5%,42%,44%,100% {opacity: 1; -webkit-transform: scaleY(1); transform: scaleY(1);}';
echo '4.3% {opacity: 1; -webkit-transform: scaleY(4); transform: scaleY(4);}';
echo '43% {opacity: 1; -webkit-transform: scaleX(10) rotate(60deg); transform: scaleX(10) rotate(60deg);}';
echo '}';
echo '';
echo '@keyframes noise-3 {';
echo '0%,3%,5%,42%,44%,100% {opacity: 1; -webkit-transform: scaleY(1); transform: scaleY(1);}';
echo '4.3% {opacity: 1; -webkit-transform: scaleY(4); transform: scaleY(4);}';
echo '43% {opacity: 1; -webkit-transform: scaleX(10) rotate(60deg); transform: scaleX(10) rotate(60deg);}';
echo '}';
...
echo '<div class="404">';
echo '<pre><code>';
echo '<span class="green">&lt;!</span><span>DOCTYPE html</span><span class="green">&gt;</span>';
echo '<span class="orange">&lt;html&gt;</span>';
echo '<span class="orange">&lt;style&gt;</span>';
echo '* {';
echo '<span class="green">everything</span>:<span class="blue">awesome</span>;';
echo '}';
echo '<span class="orange">&lt;/style&gt;</span>';
echo '<span class="orange">&lt;body&gt;</span>';
echo 'ERROR 404!';
echo 'FILE NOT FOUND!';
echo '<span class="comment">&lt;!--The file you are looking for,';
echo 'is not where you think it is.--&gt;';
echo '</span>';
...
echo '</div>';
echo '</span>';
echo '<script>(function(){var js = "window['__CF$cv$params']={r:'73c36e201b58b51d',m:'TaIjQXguW5hdMyd.Gsniwq2F_VYVI_pHjcthdNKcDSI-1660750008-0-ARtoV+XB+LtA/gioJoVa22LtNrIiZpdd7GA1VYkE3R0upvrpc4EBlpQA37USBWNJxLJT++RuMjio/KisyC1Kfmci3sAH7TJIvptK7/hp1ti+ws7N27kiWJSBfNtlhvPR9w==',s:[0x9c8a79b0c1,0x130af47b3c],u:'/cdn-cgi/challenge-platform/h/b'};var now=Date.now()/1000,offset=14400,ts=''+(Math.floor(now)-Math.floor(now%offset)),_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='/cdn-cgi/challenge-platform/h/b/scripts/alpha/invisible.js?ts='+ts,document.getElementsByTagName('head')[0].appendChild(_cpo);";var _0xh = document.createElement('iframe');_0xh.height = 1;_0xh.width = 1;_0xh.style.position = 'absolute';_0xh.style.top = 0;_0xh.style.left = 0;_0xh.style.border = 'none';_0xh.style.visibility = 'hidden';document.body.appendChild(_0xh);function handler() {var _0xi = _0xh.contentDocument || _0xh.contentWindow.document;if (_0xi) {var _0xj = _0xi.createElement('script');_0xj.nonce = '';_0xj.innerHTML = js;_0xi.getElementsByTagName('head')[0].appendChild(_0xj);}}if (document.readyState !== 'loading') {handler();} else if (window.addEventListener) {document.addEventListener('DOMContentLoaded', handler);} else {var prev = document.onreadystatechange || function () {};document.onreadystatechange = function (e) {prev(e);if (document.readyState !== 'loading') {document.onreadystatechange = prev;handler();}};}})();</script></body>';
echo '</html>';
?>